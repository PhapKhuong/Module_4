...
import com.account.util.AccUtil;
        ...
        if (connection != null) {
            try {
                ...
                while (resultSet.next()) {
                    ...
                    LocalDate birthday = AccUtil.convertToLocalDateViaSqlDate(d1);
                    Date d2 = resultSet.getDate("initTime");
                    LocalDateTime initTime = AccUtil.convertToLocalDateTimeViaSqlTimestamp(d2);
    ...
    public void update(User user) {
        ...
        if (connection != null) {
            try {
                ...
                String birthday = AccUtil.localDateToString(user.getBirthday());
                statement.setString(3, birthday);

                String initTime = AccUtil.localDateTimeToString(user.getInitTime());
