...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/resources/library.css'/>"/>
</head>
<body>
<div class="container">
    <!--TẠO THÂN TRANG-->
    <div id="body-page">
        <div class="content">
            <div class="main-content">
                ...
                <c:if test="${error==null}">
                    <!--FORM TÌM KIẾM USER-->
                    <form class="d-flex" action="/account/search-user" method="post">
                    ...
                    <h3><a href="/account">Users List</a></h3>
                    <table class="table">
                        <thread>
                            <tr>
                                ...
                                <th>
                                    <form action="/account/init-create-user" method="post">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/account/edit-user" method="post">
                                        <div class="mb-3">
                ...
                <div class="modal fade"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/account/del-user" method="post">
                                    <div class="mb-3">
...
<script type="text/javascript" src="<c:url value='/resources/bootstrap.bundle.min.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/card.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/users.js'/>"></script>
</html>