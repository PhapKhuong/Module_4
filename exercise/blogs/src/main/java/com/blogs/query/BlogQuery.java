...
public class BlogQuery {
    ...
    public static final String SELECT_ALL_BLOG =
            "SELECT * FROM blog INNER JOIN category ON blog.category_id = category.category_id";

    public static final String SELECT_BLOG_BY_ID =
            "SELECT * FROM blog INNER JOIN category ON blog.category_id = category.category_id WHERE id = :id";
