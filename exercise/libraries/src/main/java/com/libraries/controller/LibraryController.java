...
import com.libraries.exception.OffBookException;
import com.libraries.model.Book;
import com.libraries.model.Student;
import com.libraries.service.itf.IBookService;
import com.libraries.service.itf.IStudentService;
...
//
    ...
    public String initBorrowBook(@RequestParam String[] checkedBook,
        ...
        BorrowBookCard borrowBookCard = new BorrowBookCard();
        for (String str : checkedBook) {
            bookList.add(bookService.findBookById(Integer.parseInt(str)));
        }
        model.addAttribute("bookList", bookList);
        model.addAttribute("borrowBookCard", borrowBookCard);
        return "library/createCard";
    }

    @PostMapping(value = "/book/borrow")
    public String borrowBook(@ModelAttribute BorrowBookCard borrowBookCard) {
        System.out.println("come here");
        for (Book b : borrowBookCard.getBookListBorrow()) {
